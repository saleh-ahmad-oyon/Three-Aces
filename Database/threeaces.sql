...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2017 at 05:12 PM
...
CREATE TABLE `orders` (
  ...
  `asnumber` text COMMENT 'AS Number/Name',
  ...
  `region` varchar(10) DEFAULT NULL COMMENT 'Region',
  `regionName` varchar(100) DEFAULT NULL COMMENT 'Region Name',
  `timezone` text COMMENT 'Time Zone',
  `zip` int(11) DEFAULT NULL COMMENT 'Zip Code'

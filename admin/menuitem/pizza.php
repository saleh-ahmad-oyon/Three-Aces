    ...
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="<?= SERVER ?>/admin/menuitem/pizza">Pizza</a></li>
            </ul>
                ...
                <div class="box span12">
                    ...
                    <div class="box-content">
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            <button class="btn btn-success" title="Add Items" id="addPizza"><i class="halflings-icon white plus"></i> Add Item</button><br/><br/>
                            <thead>
                            <tr>
                                <th>No.</th>
                                <th>Name</th>
                            ...
                            <?php foreach($row as $key => $r): ?>
                                <tr class="tableRow" data-id="<?= htmlentities(stripcslashes($r['pizza_id']), ENT_QUOTES, 'UTF-8'); ?>">
                                    <td></td>
...
<script src="<?= SERVER ?>/admin/js/pizza-script.js"></script>
<!-- end: JavaScript-->

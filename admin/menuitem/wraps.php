    ...
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="<?php echo SERVER ?>/admin/menuitem/wraps">Wraps</a></li>
            </ul>
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <?php foreach($row as $key => $r): ?>
                                <tr class="tableRow">
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <button class="btn btn-info" title="Edit" onclick="editItem(<?php echo $r['wraps_id']; ?>);"><i class="halflings-icon white edit"></i> Edit</button>
                                            <button class="btn btn-danger" title="Delete" onclick="deleteItem(<?php echo $r['wraps_id']; ?>);"><i class="halflings-icon white trash"></i> Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
...
<script src="<?php echo SERVER ?>/admin/js/wraps-script.php"></script>
<!-- end: JavaScript-->

                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <?php foreach($row as $key => $r): ?>
                                <tr class="tableRow">
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <button class="btn btn-info" title="Edit" onclick="editItem(<?= $r['wraps_id']; ?>);"><i class="halflings-icon white edit"></i> Edit</button>
                                            <button class="btn btn-danger" title="Delete" onclick="deleteItem(<?= $r['wraps_id']; ?>);"><i class="halflings-icon white trash"></i> Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
